      ...
      <div className='acc-container'>
        {
          item.gases &&
            item.modelos.map(
              acc => <Modelo accesorio={acc} seleccionAccesorio={seleccionAccesorio} activarNoti={activarNoti} gasesHandler={gasesHandler} refNoti={refNoti}  key={acc.nombre[lang]} />
            )
        }
        {
          item.accesorioUS &&
            item.modelos.map(
              acc => <ModeloUnidSum key={acc.nombre[lang]} accesorio={acc} seleccionAccesorioUS={seleccionAccesorioUS} accesoriosUSHandler={accesoriosUSHandler} activarNoti={activarNoti} refNoti={refNoti}/>
            )
        }
      </div>
