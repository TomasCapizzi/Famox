...
function DetalleGasoterapia() {
  ...
  return(
    <section className='producto-container'>
        <Helmet>
          <title>{String(product?.nombre?.[lang] || 'Producto')}</title>
            ...
            <article className='producto'>
              ...
              <div className='info-producto'>
                <div className='img-container'>
                  <img src={product.img} alt={`producto ${product.nombre[lang]}`} />
                </div>
              ...
              */}
              ...
              {
                product.modelos_ && <Modelos modelos={product.modelos_} lang={lang} />
              }
            </article>
          :
          <Spinner />
