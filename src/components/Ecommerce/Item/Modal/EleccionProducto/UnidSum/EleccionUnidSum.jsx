        ...
        <div className='container-unidsum' >
          ...
          <div className='container-seleccion'>
            ...
            (item.nombre === 'Panel de Cabecera') ?
              ((valoresMediaTension.length > 0 || valoresBajaTension.length > 0 || valoresIluminacion.length > 0) && longitudPanel && (conexiones.length>0)) ? <Botonera agregarAlCarrito={agregarAlCarrito} toggleModal={toggleModal} borrarSelecciones={borrarSelecciones}/> : <p>Seleccionar características y longitud</p>
            : (item.nombre === 'Panel de Gases') ? ((conexiones.length > 0) && longitudPanel) ? <Botonera agregarAlCarrito={agregarAlCarrito} toggleModal= {toggleModal} borrarSelecciones={borrarSelecciones}/> : <p>Seleccionar conexiones</p>
            : (item.nombre === 'Miniducto') ? ((conexiones.length > 0) && longitudPanel) ? <Botonera agregarAlCarrito={agregarAlCarrito} toggleModal= {toggleModal} borrarSelecciones={borrarSelecciones}/> : <p>Seleccionar conexiones</p>
            :
